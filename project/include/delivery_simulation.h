...
#include "factory/drone_factory.h"
#include "factory/robot_factory.h"
#include "factory/customer_factory.h"
#include "factory/package_factory.h"
...
class DeliverySimulation : public IDeliverySystem {
  ...
  */
  ...
  /**
   * Schedules deliveries for the simulation. Does this by examining our schedule
   * vector, and searching for free drones to take respond to the scheduled instances
   */
 ...
 private:
  ...
  std::vector<IEntity*> entities_;    ///< A list of entities in the simulation
  std::vector<IEntityObserver*> entityObservers_;
  CompositeFactory compositefactory_; ///< Our composite factory
